...
puts "What is a horizontal size of the maze you want to generate? (Enter a positive integer):"
x_size = gets.chomp.to_i
puts "What is a Vertical size of the maze you want to generate? (Enter a positive integer):"
